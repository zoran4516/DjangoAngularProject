...
function chart_age(chartType, dataAge) {
    ...
    xAxis: {
		categories: ['10-17','18-25', '26-40', '41-50']
	},
	yAxis: {
		min: 0,
		max: 100,
...
// pop over
    function popOver(ele) {
        if (popOverStatus) {
            ...
            $('#color-picker-wrap').append('<div class="popOver">\
...
$('.full-back').click(function () {
    ...
    $('.wrap-full-chart').css('display', 'none');
